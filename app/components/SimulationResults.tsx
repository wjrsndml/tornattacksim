	...
	const getLogLineStyle = (message: string) => {
		...
		if (message.includes("won") || message.includes("Stalemate")) {
			if (message.includes(`${player1Name} won`)) {
				return "bg-green-100/80 border-l-4 border-green-300/80 text-green-800 font-medium";
			} else if (message.includes(`${player2Name} won`)) {
				return "bg-red-100/80 border-l-4 border-red-300/80 text-red-800 font-medium";
			} else if (message.includes("Stalemate")) {
				return "bg-yellow-100/80 border-l-4 border-yellow-300/80 text-yellow-800 font-medium";
			}
		}
